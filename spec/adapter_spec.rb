...
RSpec.describe Intelligence::Adapter, :unit do
  ...
  describe '.[]' do
    ...
    context 'when adapter class cannot be found after require' do
      ...
      it 'raises an ArgumentError' do
        ...
        }.to raise_error( ArgumentError, 'An unknown Intelligence adapter unknown_adapter was configured.' )
      end
  ...
  describe '.build' do
    ...
    it 'builds an instance of the adapter class with given type and attributes' do
      ...
      expect( adapter_instance.instance_variable_get( :@attributes ) ).to eq( attributes )
    end
